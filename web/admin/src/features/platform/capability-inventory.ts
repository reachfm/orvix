...
const PLATFORM_ROUTES: ReadonlyArray<{ method: Capability["method"]; route: string; feature: string; permission?: string }> = [
  ...
  { method: "POST", route: "/platform/organizations", feature: "organizations" },
  ...
  { method: "POST", route: "/platform/organizations/:id/deletion", feature: "organizations" },
  // Platform billing
  ...
  { method: "GET", route: "/platform/billing/tenants/:tenant_id/overview", feature: "platform-billing" },
  // Imports
  ...
  { method: "POST", route: "/platform/domains/:tenant_id/:id/dkim/generate", feature: "domains", permission: "domains.write" },
  { method: "POST", route: "/platform/domains/:tenant_id/:id/dkim/rotate", feature: "domains", permission: "domains.write" },
  { method: "POST", route: "/platform/domains/:tenant_id/:id/dkim/revoke", feature: "domains", permission: "domains.write" },
  { method: "GET", route: "/platform/domains/:tenant_id/:id/dns", feature: "domains", permission: "domains.read" },
  { method: "POST", route: "/platform/domains/:tenant_id/:id/dns/verify", feature: "domains", permission: "domains.read" },
  { method: "POST", route: "/platform/domains/:tenant_id/:id/deactivate", feature: "domains", permission: "domains.write" },
  { method: "POST", route: "/platform/domains/:tenant_id/:id/delete", feature: "domains", permission: "domains.write" },
  ...
  { method: "POST", route: "/platform/groups/:tenant_id", feature: "groups", permission: "groups.write" },
  { method: "DELETE", route: "/platform/groups/:tenant_id/:id", feature: "groups", permission: "groups.write" },
  { method: "POST", route: "/platform/groups/:tenant_id/:id/members", feature: "groups", permission: "groups.write" },
  { method: "DELETE", route: "/platform/groups/:tenant_id/:id/members/:member_id", feature: "groups", permission: "groups.write" },
