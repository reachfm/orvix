    ...
    <div className="space-y-6">
      ...
      {org && (
        <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-lg p-6">
          <div className="flex items-center gap-3 mb-4">
            <Building className="w-5 h-5 text-[var(--accent-blue)]" />
          ...
          <div className="space-y-2">
            {members.map((m: any) => (
              <div key={m.id} className="flex items-center justify-between p-3 bg-[var(--bg-base)] rounded">
                ...
                <span className="text-xs px-2 py-0.5 rounded bg-[var(--accent-blue)]/10 text-[var(--accent-blue)]">{m.role}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-lg p-4">
          <Globe className="w-5 h-5 text-[var(--accent-blue)] mb-2" />
        ...
        <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-lg p-4">
          <Mail className="w-5 h-5 text-[var(--accent-blue)] mb-2" />
        ...
        <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-lg p-4">
          <Users className="w-5 h-5 text-[var(--accent-blue)] mb-2" />
