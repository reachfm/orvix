...
export default function UsageQuotasPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {plan && (
        <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-lg p-4 text-sm">
      ...
      <div className="grid gap-4">
        {usageItems.map((item) => {
          ...
          return (
            <div key={item.label} className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <Icon className={`w-4 h-4 ${isOverLimit ? "text-red-400" : isNearLimit ? "text-yellow-400" : "text-[var(--accent-blue)]"}`} />
              ...
              <div className="h-2 bg-[var(--bg-base)] rounded-full overflow-hidden">
                <div className={`h-full rounded-full transition-all ${
                  isOverLimit ? "bg-red-500" : isNearLimit ? "bg-yellow-500" : "bg-[var(--accent-blue)]"
