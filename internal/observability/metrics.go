...
func (c *MetricsCollector) IncLicenseValidationErrors() {
	atomic.AddInt64(&c.m.LicenseValidationErrors, 1)
}
...
func (c *MetricsCollector) IncAntivirusScannerErrors() {
	atomic.AddInt64(&c.m.AntivirusScannerErrors, 1)
}
...
func (c *MetricsCollector) IncBackupTargetUploadAttempts() {
	atomic.AddInt64(&c.m.BackupTargetUploadsAttempt, 1)
}
func (c *MetricsCollector) IncBackupTargetUploadSuccess() {
	atomic.AddInt64(&c.m.BackupTargetUploadsSuccess, 1)
}
func (c *MetricsCollector) IncBackupTargetUploadFailures() {
	atomic.AddInt64(&c.m.BackupTargetUploadsFailure, 1)
}
