...
const TABLE = {
  en: {
    ...
    'sidebar.item.observability':  'Observability',
    'sidebar.item.alerts':         'Active alerts',
    'sidebar.item.storageTopology': 'Storage topology',
    'sidebar.item.tenants':        'Tenants',
    'sidebar.item.branding':       'Branding',
    'sidebar.group.tenancy':       'Multi-tenancy',
  ...
  ar: {
    ...
    'sidebar.item.observability':  'قابلة المراقبة',
    'sidebar.item.alerts':         'التنبيهات النشطة',
    'sidebar.item.storageTopology': 'طوبولوجيا التخزين',
    'sidebar.item.tenants':        'المستأجرون',
    'sidebar.item.branding':       'هوية العلامة',
    'sidebar.group.tenancy':       'متعدد المستأجرين',
    ...
    'dashboard.tab.network': 'الشبكة',
    'dashboard.tab.security': 'الأمان',
    'dashboard.tab.delivery': 'التسليم',
    'dashboard.tab.performance': 'الأداء',
    'dashboard.tab.storage':  'التخزين',
    'alerts.heading':         'التنبيهات النشطة',
    'observability.heading':  'قابلة المراقبة',
    'tenants.heading':        'المستأجرون',
    'branding.heading':       'هوية العلامة',
    'storageTopology.heading': 'طوبولوجيا التخزين',
    'dashboard.mailStats':    'إحصائيات البريد',
    'dashboard.warnings':     'التحذيرات والنشاط الأخير',
