...
const TABLE = {
  en: {
    ...
    'sidebar.mode.customer':  'Customer Admin',
    'sidebar.mode.internal':  'Orvix Internal Ops',
    'sidebar.group.mailflow': 'Mail flow',
    'sidebar.group.reports':  'Reports',
    'sidebar.group.settings': 'Settings',
    'sidebar.item.mailflow':   'Mail flow',
    'sidebar.item.reports':    'Reports',
    'sidebar.item.security':   'Security',
    'sidebar.item.settings':   'Settings',
    'sidebar.item.mailflowOps': 'Mail flow ops',
    'sidebar.item.securityOps': 'Security ops',
    'sidebar.item.domainIntel': 'Domain intelligence',
    'sidebar.group.tenants':   'Tenants',
    'sidebar.group.ops':       'Operations',
    'sidebar.group.branding':  'Branding & tenant controls',
  ...
  ar: {
    ...
    'sidebar.mode.customer':  'إدارة العميل',
    'sidebar.mode.internal':  'عمليات Orvix الداخلية',
    'sidebar.group.mailflow': 'تدفق البريد',
    'sidebar.group.reports':  'التقارير',
    'sidebar.group.settings': 'الإعدادات',
    'sidebar.item.mailflow':   'تدفق البريد',
    'sidebar.item.reports':    'التقارير',
    'sidebar.item.security':   'الأمان',
    'sidebar.item.settings':   'الإعدادات',
    'sidebar.item.mailflowOps': 'عمليات تدفق البريد',
    'sidebar.item.securityOps': 'عمليات الأمان',
    'sidebar.item.domainIntel': 'استخبارات النطاقات',
    'sidebar.group.tenants':   'المستأجرون',
    'sidebar.group.ops':       'العمليات',
    'sidebar.group.branding':  'هوية العلامة وتحكمات المستأجرين',
    'sidebar.group.admin':     'الإدارة',
